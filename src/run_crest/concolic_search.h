...
class Search {
 ...
 protected:
  map<branch_id_t, vector<int> > static_fv_map_;
  ...
  bool UpdateCoverage(const vector<value_t>& inputs, const SymbolicExecution& ex);
  bool UpdateCoverage(const vector<value_t>& inputs, const SymbolicExecution& ex,
  ...
  */
  ...
  void PrintOnly(const vector<value_t>& input); 
};
